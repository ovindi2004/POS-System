import {getItemData} from '../model/item.js';
import {getOrderData} from '../model/order.js';
...
const buildCharts = () => {
    ...
    buildStockChart(items);
    buildRevenueChart(items, orders);
    buildOrdersChart(orders);
}

// --------------------------- Stock Chart ---------------------------
const buildStockChart = (items) => {
...
// --------------------------- Revenue Chart ---------------------------
const buildRevenueChart = (items, orders) => {
    const revMap = {};
    orders.forEach(o => {
